...
- Name: recommendations.spec.ts >> Recommendation Wizard >> step 1 shows all 5 quality tiers
- Location: tests/recommendations.spec.ts:66:7
...
Locator: getByText('Good')
Expected: visible
Error: strict mode violation: getByText('Good') resolved to 2 elements:
    1) <div class="font-semibold text-sm text-gray-900 dark:text-gray-100">Good enough</div> aka getByRole('button', { name: '1 Good enough Fast and cheap' })
    2) <div class="font-semibold text-sm text-gray-900 dark:text-gray-100">Good</div> aka getByRole('button', { name: '3 Good Reliable quality for' })

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('Good')
