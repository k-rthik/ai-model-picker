...
- Name: recommendations.spec.ts >> Recommendation Results — correctness >> runner up is shown when available
- Location: tests/recommendations.spec.ts:148:7

# Error details

```
Error: locator.textContent: Error: strict mode violation: locator('text=Runner Up').locator('../..').locator('text=/\\$.*/1M/') resolved to 5 elements:
    1) <strong>$0.07/1M</strong> aka getByText('$0.07/1M')
    2) <strong>$0.11/1M</strong> aka getByRole('strong').filter({ hasText: '$0.11/1M' })
    3) <p class="text-sm text-gray-600 dark:text-gray-300 mb-5 leading-relaxed">Qwen: Qwen3 Coder Next scores 9.2/10 for coding a…</p> aka getByText('Qwen: Qwen3 Coder Next scores')
    4) <div class="font-bold text-green-700 dark:text-green-400">$0.11/1M</div> aka locator('div').filter({ hasText: /^\$0\.11\/1M$/ })
    5) <div class="text-sm text-gray-500 dark:text-gray-400 mt-1">$0/1M input · fast speed</div> aka getByText('$0/1M input · fast speed')

Call log:
  - waiting for locator('text=Runner Up').locator('../..').locator('text=/\\$.*/1M/')
        ...
        - generic [ref=e53]:
          - generic [ref=e54]:
            ...
            - generic [ref=e56]:
              ...
              - paragraph [ref=e58]:
                - text: "Qwen: Qwen3 Coder 30B A3B Instruct is"
                - generic [ref=e59]: 58% cheaper
                - text: "than Qwen: Qwen3 Coder Next for coding, with only a"
                - generic [ref=e60]: 0.4-point
                - text: quality drop.
              - generic [ref=e61]:
                - generic [ref=e62]:
                  - text: "Qwen: Qwen3 Coder 30B A3B Instruct:"
                  - strong [ref=e63]: $0.07/1M
                - generic [ref=e64]:
                  - text: "Qwen: Qwen3 Coder Next:"
                  - strong [ref=e65]: $0.11/1M
            - button "Dismiss" [ref=e66]: ×
          - generic [ref=e67]:
            - generic [ref=e68]:
              - generic [ref=e69]:
                - generic [ref=e70]: Top Pick
                - generic [ref=e71]: "Qwen: Qwen3 Coder Next"
              - generic [ref=e72]: Qwen
            - paragraph [ref=e73]: "Qwen: Qwen3 Coder Next scores 9.2/10 for coding at $0.11/1M input and $0.80/1M output tokens."
            - generic [ref=e74]:
              - generic [ref=e75]:
                - generic [ref=e76]: Input price
                - generic [ref=e77]: $0.11/1M
              - generic [ref=e78]:
                - generic [ref=e79]: Context
                - generic [ref=e80]: 262K
              - generic [ref=e81]:
          ...
          - generic [ref=e83]:
            ...
            - generic [ref=e85]:
              - generic [ref=e86]: "Qwen: Qwen3 Coder 480B A35B (free)"
              - generic [ref=e87]: Qwen
            - generic [ref=e88]: $0/1M input · fast speed
