...
- Name: recommendations.spec.ts >> Recommendation Results — correctness >> context window displays as K or M format
- Location: tests/recommendations.spec.ts:167:7

# Error details

```
Error: locator.textContent: Error: strict mode violation: locator('text=Context').locator('../..') resolved to 2 elements:
    1) <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">…</div> aka getByText('Models tracked406Cheapest')
    2) <div class="grid grid-cols-3 gap-4">…</div> aka getByText('Input price$1.25/1MContext2.')

Call log:
  - waiting for locator('text=Context').locator('../..')
        ...
        - generic [ref=e53]:
          - generic [ref=e54]:
            ...
            - generic [ref=e56]:
              ...
              - paragraph [ref=e58]:
                - text: "Qwen: Qwen3.6 35B A3B is"
                - generic [ref=e59]: 77% cheaper
                - text: "than xAI: Grok 4.20 Multi-Agent for analysis, with only a"
                - generic [ref=e60]: 0.2-point
                - text: quality drop.
              - generic [ref=e61]:
                - generic [ref=e62]:
                  - text: "Qwen: Qwen3.6 35B A3B:"
                  - strong [ref=e63]: $0.14/1M
                - generic [ref=e64]:
                  - text: "xAI: Grok 4.20 Multi-Agent:"
                  - strong [ref=e65]: $1.25/1M
            - button "Dismiss" [ref=e66]: ×
          - generic [ref=e67]:
            - generic [ref=e68]:
              - generic [ref=e69]:
                - generic [ref=e70]: Top Pick
                - generic [ref=e71]: "xAI: Grok 4.20 Multi-Agent"
              - generic [ref=e72]: X-ai
            - paragraph [ref=e73]: "xAI: Grok 4.20 Multi-Agent scores 9.4/10 for analysis at $1.25/1M input and $2.50/1M output tokens."
            - generic [ref=e74]:
              - generic [ref=e75]:
                - generic [ref=e76]: Input price
                - generic [ref=e77]: $1.25/1M
              - generic [ref=e78]:
                - generic [ref=e79]: Context
                - generic [ref=e80]: 2.0M
              - generic [ref=e81]:
          ...
          - generic [ref=e83]:
            ...
            - generic [ref=e85]:
              - generic [ref=e86]: "xAI: Grok 4.20"
              - generic [ref=e87]: X-ai
