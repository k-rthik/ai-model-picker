...
import { ModelCompareTable } from './compare/ModelCompareTable'
import { CostCalculator } from './calculator/CostCalculator'
import { RecommendationWizard } from './recommend/RecommendationWizard'
import { ThemeToggle } from './shared/ThemeToggle'
import { BrandMark } from './shared/BrandMark'
import { CliRouterPanel } from './cli/CliRouterPanel'

export type Tab = 'compare' | 'cost' | 'recommend' | 'cli'
...
export function HomeShell({ initialTab = 'recommend' }: { initialTab?: Tab }) {
        ...
        {tab !== 'cli' && loading && (
          <div className="flex items-center justify-center h-64 text-gray-500 dark:text-gray-400">
            <div className="text-center space-y-2">
              ...
              <div className="font-mono text-xs uppercase tracking-[0.25em]">Waking the models…</div>
            </div>
          </div>
        )}
